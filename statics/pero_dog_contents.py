pero_dog_contents = [
    ...
    '今天你问我借了两千块钱，说要做个手术，你果然还是爱我的，**不是我的孩子，你不要**。 ', '中午你无故扇了我一巴掌，我握着你的手说“手怎么这么凉，都怪我没有照顾好你，一定要更加对你好”。',
    ...
    '找你连麦时你说你在忙工作，每次聊天你都说在忙，你真是一个**上进的好女孩**，你真好，发现我越来越喜欢这样优秀的你。', '你从来没说过爱我，聊天记录搜索了一下“爱”，唯一的一条是：**你好像乡村爱情里的刘能啊**。',
    '今天好开心啊，和你一起在峡谷嬉戏，打完一波团战之后看到你在打大龙，残血的我跳过去直接被龙爪拍死，但这一刻我觉得好浪漫，**死在你的脚旁边，这是我离你最近的一次**。', '哥们，求你和她说句话吧，这样她就不会那么难过了。',
    ...
    '我打游戏太菜了，偶尔跌跌撞撞摘了几颗星星，总是又掉下来，**我守不住上一把摘掉的星星，也守不住你。**', '今天天气有点冷，想偷你的心却还是没有成功，在床上的我现在的心情就像天气预报，说**明天有雨，我都听成明天有你。**',
    ...
    '天气很暖和，但是风有点大，坐在保安亭内看见了你挽着一个陌生男人出了门，看起来很亲密，**你问我附近哪里有毓婷卖**，我指给你看了，好开心，你跟我说话了。', '我可以再见你一面吗，我可以站远一点，不让你同事发现我。',
    '今天的彩虹桥格外的迷人，可是当你站在彩虹桥下，它便暗淡了许多，原来你才是最迷人的。', '给你发了几千条消息，你终于把我拉黑了。我好开心，那是你对我的唯一回应。我哭了好久，终于等到你的回应了，你放心，我会继续爱你。',
    ...
    '你扇了我一巴掌，我握着你的手说“**怎么这么凉**”', '她好像从来没有主动找过我，我看了一下我们的聊天记录，只有情人节这天给我发的入住酒店叫我帮她砍一刀。',
    ...
    '我的嘴真笨，总能把天聊死了！跟你找话题好难，何况我又这么喜欢你，连发个表情包都要挑拣半天呢！我最近开始期待夜晚了，其实我在说：“**今天我也很喜欢你，也想你了！**”', '你还有钱吗？没有我给你打点。',
    ...
    '现在已经凌晨一点多了，我望着手机屏幕迟迟没有他的消息：你知道吗？我等了一晚上你的消息。他终于回复我了：是我让你等的？', '今天我鼓起勇气问她是喜欢狼狗还是喜欢奶狗，她说她喜欢狼狗，我问她觉得我是哪一种，**她说我是土狗。**',
    ...
    '今天一个女孩子对我表白说喜欢我，可是我的心里只有你啊，我立马拒绝了她，她说她不会放弃的，我的心里只有你一个人啊，不会答应她的。', '话说今天发工资了，五千，你猜猜看我会给你多少？四千多？不对，我把我的卡给你，密码你的生日。',
    '早上你和我说你腰酸死了，昨天晚上累坏了吧，我还是会给你做好吃的，果然你什么时候都是好看的。', '你今天**让我交钱的时候发的字是最多的**，我想你一定更爱我了，都粘着我了，我一定努力赚钱的。',
    ...
    '她从来不说想我，聊天记录搜索了一下“想你”两个字全都是：“**那波你怎么不上啊，你在想你妈呢。**”', '她好像从来没有主动说过爱我，我搜索了一下关键字“爱”。在我们的聊天记录里，她只说过一次：**你爱怎么想就怎么想**',
    ...
    '我今天送了你一支口红，你拿到之后很开心，在他的嘴巴上亲了一下，或许他送你口红的时候，你也会在我的嘴巴上亲一下吧。', '你说憧憬过以后的生活，可你也没有说，憧憬过离开我的生活',
    ...
    '我们通过网上认识的，给你送了LV、YSL等你都没有拒绝，当看到你朋友圈说想出来走走的时候，我立马给你私信小窗口，你回了一句**见你妈**，我就知道你还是想跟我过日子的', '我拥抱着残留你气息的空气，假装你还在，不曾离去。',
    ...
    '你说你的床太小，没关系啊，我们三个一起睡啊。', '他给每个人都发了节日快乐，而我的却打了几个句号，我开心极了',
    ...
    '我想你一定很忙，所以你只要看前三个字就好了。', '我跪着看你特别美。',
    ...
    '今天麦当劳桶半价，我赶紧买一份想要送给你，想告诉你**桶有半价，爱你无价。**可是我好笨，爱你说不出来 ，桶也保护不好。我委屈，我想你。', '兄弟，我帮你刷本，你多去陪陪她。',
    '你说你喜欢冰淇淋，我可以给你买，你说你喜欢AJ1，我可以给你买，你说你喜欢iPhone11，我可以给你买，可是为什么就是**买不了你对我的喜欢。**', '天上的月亮，亮也没用，没用也亮；我喜欢你，喜欢也没用，没用也喜欢。',
    ...
    '天空的乌云好像也有心事一样，那个女孩还是没有回复我一句话，可能她爱我不好意思说出口吧！', '今天看到你发朋友圈说你分手了，我很开心，因为你说我是63号，今天开始我就是62号了，距离和你在一起又进一步了。',
    ...
    '我知道你不会来到这个网站，但我还是想对你说：“我喜欢你，邱。”', '能不能先别嫁他，彩票我每天都在坚持买……', '轻点，她怕疼。',
    ...
    '你这个人不太会撒娇，说不太出这种以呐结尾的句子。我在我们的聊天记录中搜索了关键字“呐”，你经常和我说：我给你妈吹唢呐！', '问你在干嘛，你问我能不能别烦你。居然询问我的意见，态度真好，真喜欢你！',
    '孩子是不是我的无所谓，你生孩子都那么疼了。', '今天和女神去爬山，她的脚崴了，蹲在地上小声的哭，我过去搂着她说：“怎么回事，没吃饭么？哭都哭不出来？”',
    '给自己花钱也许会心疼，但给喜欢的人花钱却是快乐的，而且这种快乐没有人可以剥夺，没有人可以从中作梗，它是属于我一个人的幸福，永远。', '今天加了女神的微信，我说晚上请她看电影，她说看你妈。真好，那么快就想着见家长了。',
    ...
    '和他退房了吗？可以回我消息了吗？', '昨晚和你缠绵的时候特别开心，应该说每晚受你邀约去你家我都很开心，第二天依旧按照约定九点前我就离开，今天意外收到了你的信息，你嘱咐我说：丽丽注意安全，下回见。我更加开心了，尽管我叫菲菲。',
    '再也不做舔狗了，从今往后你走你的独木桥，我在桥下为你撑着。走的时候小心点别掉下来了，我会心疼的。', '昨天，我给你发了一句“早安”，你没有回我，我还能等，我可以等很久，直到你回过头来看我哪怕一眼。',
    ...
    '每天点开你的QQ资料卡，看着你的头像。啊，换头像了？是不是情侣头像啊？我心里一惊，心跳加速，赶紧上网搜，好像不是情侣头像，那我是不是还有机会啊……', '听说你和你的女友分手了，我以为机会来了。没想到你又有了新的女友。',
    '给你发了好几百条信息了，你也不回，我都想不理你了，可是你突然回了一个“嗯”，我的快乐又回来了。哈哈哈哈哈哈哈哈哈', '你知道吗？流星雨划过天空的时候，我许了一个你愿望成真的愿望。',
    '今天口腔溃疡了，不太想舔你了，但是我爱你，含了一片西瓜霜后，又给你发了99条信息。', '今天又被女神感动到了，陪她去打胎，她躺在病床上虚弱的对我说“**亲爱的，不是你的孩子我不要。**”',
    '给她发信息，就问了一句你好，她就让我哪凉快去哪呆着。果然她还是爱我的，怕我在这么热的天，热着了，你放心我这一生只会爱你一个人的。', '你说别缠着你了并给我看了你女朋友的照片，啊~不愧是你！女朋友都这么漂亮~',
    ...
    '对不起，我接受不了网恋，虚无缥缈的东西没办法给我带来安全感，猜忌和怀疑是深夜流泪的根源，我要稳稳的幸福，一伸手就能触碰的那种 ，但看到你这张照片我就知道：我能接受。', '没关系的，我可以用好友申请每天向你问好。',
    '“她根本就不喜欢你，她喜欢的是你的钱！”，“胡说！那别人的钱她怎么不喜欢就喜欢我的钱？还不是因为喜欢我！”', '你今天突然给我发消息说你搬家让我来帮你，我立马跑来，帮你跑上跑下，后来你说，辛亏是你，不然我男朋友会累坏的',
    '昨天早上给你问好，你说今天七夕想给男朋友惊喜，我给你转了520，你开了间水床房，说不舍得男朋友花钱！', '没事，你有对象不重要，你可以偶尔回一下我的信息好吗，一天一条也行，让我知道你还在。',
    '昨天晚上我给你发短信，你回了一句“等等”，然后我就双眼盯着屏幕等到天亮你也再没有回信息，我想一定是你担心我睡眠不足，所以没有回我。', '多希望有一天你对我说：“宝，早安！”，而不是：“早，保安！”',
    '留下的TT，你和现在的他继续用吧！', '我不敢有什么奢望，只希望亲他的时候要记得涂上我送你的唇膏.......',
    '我记得你唯一和我说过有关于我的话题于评价是：你这个人好烦啊，给我闭嘴，滚远点好吗？我真的好感动啊，你知道我最近嗓子不好，要我少说话；也知道我的炎症会传染，所以才让我走开；真是太关心我了，我好爱你呀！！！',
    '上课用镜子偷偷在看你，想着光的反射，你看我这边你就可以看到我，一节课硬是没看到你在看我。', '以后你的屎就拉在我嘴里吧！', '他说：“你不要再打电话了，请你不要做第一个被我拉黑的女生”',
    '我说我想要甜甜的恋爱，他说馊的就有，我说馊的我也要！', '给你买的iPhone11刚分期完，iPhone12就出了，这个时候你来找我复合，我就知道你还是爱我的，谢谢你苹果公司！',
