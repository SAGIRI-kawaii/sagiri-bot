...
from .utils import get_voice, mockingbird_available, models, models_available, set_accuracy, set_model
...
@channel.use(
    ListenerSchema(
        ...
        inline_dispatchers=[
            Twilight([get_command(__file__, channel.module), WildcardMatch().flags(re.DOTALL) @ "content"])
        ],
        decorators=[
