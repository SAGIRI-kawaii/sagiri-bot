...
- 从 [mcl-installer release](https://github.com/iTXTech/mcl-installer/releases/latest) 下载对应自己系统架构的二进制文件
...
- 执行 `bash 刚下载的文件名.sh`，如 `bash Anaconda3-5.3.1-Linux-x86_64.sh` 或 `bash Miniconda3-latest-Linux-x86_64.sh`
